...
namespace WpfApp.Helpers
{
    ...
    public class MultiSelectBindingHelper : DependencyObject
    {
        public static readonly DependencyProperty IsSubscribedToSelectionChangedProperty = DependencyProperty.RegisterAttached(
        "IsSubscribedToSelectionChanged", typeof(bool), typeof(MultiSelectBindingHelper), new PropertyMetadata(default(bool)));
        ...
        public static readonly DependencyProperty SelectedItemsProperty = DependencyProperty.RegisterAttached(
            "SelectedItems", typeof(IList), typeof(MultiSelectBindingHelper), new PropertyMetadata(default(IList), OnSelectedItemsChanged));
